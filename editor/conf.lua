function love.conf(t)
    ...
    t.window.title = "Little Planet"        -- The window title (string)
...
config = {
    gameTitle = "Little Planet",
    windowTitle = "Little Planet",
    windowIcon = 'img/other/LittlePlanetIcon.png',
    ...
    fontBold = 'fonts/Oswald-Bold.ttf',
    fontLight = 'fonts/Oswald-Light.ttf',
}
